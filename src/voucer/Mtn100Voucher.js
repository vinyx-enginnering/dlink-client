          ...
          pins.vouchers.map((pin) => (
            ...
            >
              <div style={{ height: "90px" }}>
                ...
                >
                  <p
                    className="bg-warning text-light px-1 pt-1 lead"
                    style={{
                      width: "50%",
                ...
                <div style={{ display: "flex" }}>
                  <div className="px-1 py-1" style={{ width: "90%" }}>
                    ...
                    <p
                      className="p-0 m-0 text-warning"
                      style={{ fontSize: "13px" }}
                    >
                      MTN{" "}
                  ...
                  >
                    <img
                      src={require("../assets/images/mtn.png")}
