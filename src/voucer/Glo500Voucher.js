...
function Glo500Voucher() {
  const dispatch = useDispatch();
  const componentRef = useRef();

  useEffect(() => {
    dispatch(getCard("Glo"));
  }, []);
            ...
            >
              ...
              >
                <div style={{ display: "flex", flexDirection: "row" }}>
                  <h4
                    className="bg-success text-light px-1 pt-1"
                    style={{ width: "50%", borderBottomRightRadius: "20px" }}
                  >
                ...
                <div style={{ display: "flex" }}>
                  ...
                  >
                    <img
                      src={require("../assets/images/glo.png")}
