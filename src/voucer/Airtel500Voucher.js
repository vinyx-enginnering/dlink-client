...
function Airtel500Voucher() {
  ...
  return (
    <Fragment>
       <ReactToPrint
          trigger={() => <button className="btn btn-md mx-4 my-2 mt-1 btn-dark">Print this out!</button>}
              ...
              <div style={{ height: "120px" }}>
                ...
                <div style={{ display: "flex" }}>
                  <div className="px-1" style={{ width: "90%" }}>
                    ...
                    <h4
                      className="p-0 m-0"
                      style={{ fontSize: "1.2rem", color: "#d201bb" }}
                    >
                      Airtel{" "}
...
export default Airtel500Voucher;
