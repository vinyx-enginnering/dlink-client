              ...
              <div style={{ height: "120px" }}>
                ...
                <div style={{ display: "flex" }}>
                  <div className="px-1" style={{ width: "90%" }}>
                    ...
                    >
                      MTN <small style={{ fontSize: "1rem" }}>{DateFormatter(pin.createdAt).shortDate()}</small>
                    </h4>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    <img
                      src={require("../assets/images/mtn5.png")}
