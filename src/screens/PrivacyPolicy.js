    ...
    <Fragment>
      <div className="container mt-3">
        <div className="bg-light p-5">
          <h1 className="display-2" style={{color: "#8c5eff"}}>Terms & Conditions</h1>
          <p className="display-6 mb-5">Updated at 2022-07-18</p>

          <h1 className="">General Terms</h1>
          <p >
            By accessing and placing an order with Doublelink Mobile, you
            ...
            communication between you and Doublelink Mobile.
          </p>
          <p>
            Under no circumstances shall Doublelink Mobile team be liable for
            ...
            even if Doublelink Mobile team or an authorized representative has
          ...
          <p>
            Doublelink Mobile will not be responsible for any outcome that may
          ...
          <h1>License</h1>
          <p>
            Doublelink Mobile grants you a revocable, non-exclusive,
          ...
          <p>
            These Terms & Conditions are a contract between you and Doublelink
            Mobile (referred to in these Terms & Conditions as "Doublelink
            Mobile", "us", "we" or "our"), the provider of the Doublelink Mobile
            website and the services accessible from the Doublelink Mobile
            website (which are collectively referred to in these Terms &
            Conditions as the "Doublelink Mobile Service").
          </p>
          <p>
            ...
            Doublelink Mobile Service. In these Terms & Conditions, "you" refers
          ...
          <ul>
            ...
            <li>
              ...
              “our,” it refers to Doublelink PLC, Km 88 Idiroko Road, Ota, Ogun
              State, Nigeria that is responsible for your information under this
              Terms & Conditions.
            </li>
            <li>
              Country: where Doublelink Mobile or the owners/founders of
              Doublelink Mobile are based, in this case is NG
            </li>
            <li>
              Device: any internet connected device such as a phone, tablet,
              computer or any other device that can be used to visit Doublelink
              Mobile and use the services.
            </li>
            <li>
              Service: refers to the service provided by Doublelink Mobile as
            ...
            <li>
              Website: Doublelink Mobile's site, which can be accessed via this
              URL:{" "}
            </li>
            <li>
              You: a person or entity that is registered with Doublelink Mobile
              to use the Services.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              ...
              notice of copyright or trademark) of Doublelink Mobile or its
              affiliates, partners, suppliers or the licensors of the app.
            </li>
          </ul>
          <h1>Return and Refund Policy</h1>
          <p>
            Thanks for shopping at Doublelink Mobile. We appreciate the fact
          ...
          <p>
            ...
            apply to transactions at Doublelink Mobile. We’ll be as brief as our
            attorneys will allow. The main thing to remember is that by placing
            an order or making a purchase at Doublelink Mobile, you agree to the
            terms along with Doublelink Mobile's Privacy Policy.
          </p>
          <p>
          ...
          <p>
            ...
            (collectively, "Suggestions") provided by you to Doublelink Mobile
            with respect to the app shall remain the sole and exclusive property
            of Doublelink Mobile.
          </p>
          <p>
            Doublelink Mobile shall be free to use, copy, modify, publish, or
          ...
          <p>
            ...
            Doublelink Mobile. We are not responsible for the content, accuracy
          ...
          <h1>Cookies</h1>
          <p>
            Doublelink Mobile uses "Cookies" to identify the areas of our
          ...
          <p>
            You acknowledge and agree that <a href="">Doublelink Mobile</a>may
            stop (permanently or temporarily) providing the Service (or any
            features within the Service) to you or to users generally at{" "}
            <a href="">Doublelink Mobile</a>’s sole discretion, without prior
            notice to you. You may stop using the Service at any time. You do
            not need to specifically inform <a href="">Doublelink Mobile</a>{" "}
            when you stop using the Service. You acknowledge and agree that if{" "}
            <a href="">Doublelink Mobile</a> disables access to your account,
          ...
          <p>
            Doublelink Mobile reserves the right to modify, suspend or
          ...
          <p>
            Doublelink Mobile may from time to time provide enhancements or
          ...
          <p>
            ...
            of the app. You agree that Doublelink Mobile has no obligation to
          ...
          <p>
            You acknowledge and agree that Doublelink Mobile shall not be
            ...
            decency, quality or any other aspect thereof. Doublelink Mobile does
          ...
          <p>
            Doublelink Mobile may, in its sole discretion, at any time and for
          ...
          <p>
            ...
            Doublelink Mobile, in the event that you fail to comply with any
          ...
          <p>
            Termination of this Agreement will not limit any of Doublelink
            Mobile's rights or remedies at law or in equity in case of breach by
          ...
          <p>
            You agree to indemnify and hold Doublelink Mobile and its parents,
          ...
          <p>
            ...
            extent permitted under applicable law, Doublelink Mobile, on its own
            ...
            foregoing, Doublelink Mobile provides no warranty or undertaking,
          ...
          <p>
            Without limiting the foregoing, neither Doublelink Mobile nor any
            Doublelink Mobile's provider makes any representation or warranty of
            ...
            or on behalf of Doublelink Mobile are free of viruses, scripts,
          ...
          <p>
            ...
            liability of Doublelink Mobile and any of its suppliers under any
          ...
          <p>
            ...
            Doublelink Mobile or its suppliers be liable for any special,
            ...
            in connection with any provision of this Agreement), even if
            Doublelink Mobile or any supplier has been advised of the
          ...
          <p>
            ...
            notices published by Doublelink Mobile on the Services, shall
            constitute the entire agreement between you and Doublelink Mobile
            ...
            Doublelink Mobile's failure to assert any right or provision under
            this Agreement shall not constitute a waiver of such right or
            provision. YOU AND Doublelink Mobile AGREE THAT ANY CAUSE OF ACTION
          ...
          <p>
            Doublelink Mobile reserves the right, at its sole discretion, to
          ...
          <p>
            ...
            Doublelink Mobile regarding your use of the app and supersedes all
          ...
          <p>
            ...
            when you use or purchase other Doublelink Mobile's services, which
            Doublelink Mobile will provide to you at the time of such use or
            purchase.
          </p>
          ...
          <p>
            ...
            arrangement thereof), are owned by Doublelink Mobile, its licensors
            or other providers of such material and are protected by NG and
            ...
            permission of Doublelink Mobile, unless and except as is expressly
          ...
          <p>
            ...
            REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Doublelink Mobile's
            INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute,
            action, or other controversy between you and Doublelink Mobile
          ...
          <p>
            In the event of a dispute, you or Doublelink Mobile must give the
            ...
            <a
              ...
              class="__cf_email__"
              data-cfemail="463533363629343206222933242a232a2f282d28216825292b68"
            >
              [email&#160;protected]
            </a>{" "}
            Doublelink Mobile will send any Notice of Dispute to you by mail to
            your address if we have it, or otherwise to your email address. You
            and Doublelink Mobile will attempt to resolve any dispute through
            informal negotiation within sixty (60) days from the date the Notice
            of Dispute is sent. After sixty (60) days, you or Doublelink Mobile
            may commence arbitration.
          </p>

          <h1>Binding Arbitration</h1>
          <p>
            If you and Doublelink Mobile don’t resolve any dispute by informal
          ...
          <p>
            ...
            property of Doublelink Mobile without any compensation or credit to
            you whatsoever. Doublelink Mobile and its affiliates shall have no
          ...
          <h1>Promotions</h1>
          <p>
            Doublelink Mobile may, from time to time, include contests,
          ...
          <p>
            ...
            signed by an authorized representative of Doublelink Mobile.
            Doublelink Mobile will be entitled to injunctive or other equitable
            relief (without the obligations of posting any bond or surety) in
            the event of any breach or anticipatory breach by you. Doublelink
            Mobile operates and controls the Doublelink Mobile Service from its
            offices in NG. The Service is not intended for distribution to or
            ...
            Accordingly, those persons who choose to access the Doublelink
            Mobile Service from other locations do so on their own initiative
            and are solely responsible for compliance with local laws, if and to
            the extent local laws are applicable. These Terms & Conditions
            (which include and incorporate the Doublelink Mobile Privacy Policy)
            contains the entire understanding, and supersedes all prior
            understandings, between you and Doublelink Mobile concerning its
          ...
          <h1>Disclaimer</h1>
          <p>
            Doublelink Mobile is not responsible for any content, code or any
            other imprecision.
          </p>
          <p>Doublelink Mobile does not provide warranties or guarantees.</p>
          <p>
            In no event shall Doublelink Mobile be liable for any special,
          ...
          <p>
            The Doublelink Mobile Service and its contents are provided "as is"
            and "as available" without any warranty or representations of any
            kind, whether express or implied. Doublelink Mobile is a distributor
            and not a publisher of the content supplied by third parties; as
            such, Doublelink Mobile exercises no editorial control over such
            ...
            merchandise provided through or accessible via the Doublelink Mobile
            Service. Without limiting the foregoing, Doublelink Mobile
            specifically disclaims all warranties and representations in any
            content transmitted on or in connection with the Doublelink Mobile
            Service or on sites that may appear as links on the Doublelink
            Mobile Service, or in the products provided as a part of, or
            otherwise in connection with, the Doublelink Mobile Service,
            including without limitation any warranties of merchantability,
            fitness for a particular purpose or non-infringement of third party
            rights. No oral advice or written information given by Doublelink
            Mobile or any of its affiliates, employees, officers, directors,
            ...
            the foregoing, Doublelink Mobile does not warrant that the
            Doublelink Mobile Service will be uninterrupted, uncorrupted,
