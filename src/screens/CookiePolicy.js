  ...
  return (
    ...
    <div className="container mt-3">
      <div className="bg-light p-5">
        <h1 className="display-2" style={{color: "#8c5eff"}}>Cookie Policy</h1>
        ...
        <ul>
          ...
          <li>
            ...
            it refers to Doublelink Mobile, that is responsible for your
        ...
        <h1>Introduction</h1>
        <p>
          This Cookie Policy explains how Doublelink Mobile and its affiliates
          (collectively "Doublelink Mobile", "we", "us", and "ours"), use
          cookies and similar technologies to recognize you when you visit our
          website/app, including without limitation https://doublelinkng.com and
          any related URLs, mobile or localized versions and related domains /
          sub-domains ("Websites"). It explains what these technologies are and
          why we use them, as well as the choices for how to control them.
        </p>
        ...
        <ul>
          ...
          <li>
            You: a person or entity that is registered with Doublelink Mobile to
            use the Services.
          </li>
        </ul>

        <h1>What type of cookies does Doublelink Mobile use?</h1>
        <p>
        ...
        <p>
          ...
          in order to enable you to navigate around the website/app and use its
          features. If you remove or disable these cookies, we cannot guarantee
          that you will be able to use our website/app.
        </p>
        <p>We use the following types of cookies in our website/app:</p>
        <h1>Essential Cookies</h1>
        <p>
          We use essential cookies to make our website/app work. These cookies
          are strictly necessary to enable core functionality such as security,
        ...
        <p>
          ...
          time you visit the website/app as we would not be able to remember
        ...
        <p>
          ...
          how our website/app is being used or how effective our marketing
          campaigns are, or to help us customize our website/app for you.
        </p>
        <p>
        ...
        <p>
          ...
          preventing the same ad from continuously reappearing and ensuring that
          ads are properly displayed for advertisers. Without cookies, it’s
        ...
        <p>
          ...
          such as Facebook, Twitter or Google+. The social network will record
          that you have done this. These cookies may also include certain code
          that has been placed on the platform to help track conversions from
          ads, optimize ads based on collected data, build targeted audiences
          for future ads, and remarket to qualified users who have already taken
        ...
        <p>
          ...
          first party basis by Doublelink Mobile. The Websites can be embedded
          with content from third parties to serve advertising. These third
          party service providers may set their own cookies on your web browser.
          ...
          above. We do not control the use of these third party cookies as
          cookies can only be accessed by the third party that originally set
          them.
        </p>
        ...
        <ul>
          <li>
            ...
            <a
              ...
              class="__cf_email__"
              data-cfemail="82f1f7f2f2edf0f6c2e6edf7e0eee7eeebece9ece5ace1edef"
            >
              [email&#160;protected]
            </a>
          </li>
